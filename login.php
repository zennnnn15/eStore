...
$client->setClientId('487676158964-8i61cesqau7n204vqh8c77hr2htvlk87.apps.googleusercontent.com');
// Enter your Client Secrect
$client->setClientSecret('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');
...
<body>
  ...
  <div>
    ...
    <span id="retype-password-error" class="error"></span>
  </div>
  <button type="submit">Register</button>
  <br>
  <p>Existing User?</p>
  <input type="button" value="Login" name="login" class="login-btn" onclick="redirectToRegister()">
